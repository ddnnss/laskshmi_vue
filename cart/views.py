...
def use_promo(request):
    ...
    if code:
        ...
        if used_promo:
            ...
            return_dict['result'] = 'Прокод уже был использован ранее'
        else:
            ...
            if not code_valid:
                return_dict['result'] = 'Прокод не действительный'
            else:
                ...
                return_dict['result'] = 'Прокод успешно применен'
                return_dict['total_cart_price'] = total_cart_price
                return_dict['total_cart_price_with_discount'] = total_cart_price_with_discount
                return_dict['promo_discount_value'] = promo_discount_value
        ...
        return_dict['result'] = 'Прокод не найден'
    return JsonResponse(return_dict)
